                  ...
                  <div className="flex items-center gap-3">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {manager.automatic_assignment_enabled && <span className="rounded bg-blue-100 px-1.5 py-0.5 text-xs text-blue-700 dark:bg-blue-900/40 dark:text-blue-300">Pool 有効</span>}
                    ...
                    <button type="button" onClick={() => handleToggleAutomaticAssignment(index)} className="rounded border border-gray-300 px-2 py-1 text-xs text-gray-600 dark:border-gray-600 dark:text-gray-300">
					  {manager.automatic_assignment_enabled ? 'Pool を無効化' : 'Pool を有効化'}
                    </button>
