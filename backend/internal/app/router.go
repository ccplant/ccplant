...
func (r *Router) registerCoreRoutes() error {
	...
	if r.handlers.provisionerController != nil {
		...
		r.echo.POST("/internal/worker/sessions/:sessionId", r.handlers.provisionerController.CreateWorkerSession)
		r.echo.GET("/internal/worker/sessions", r.handlers.provisionerController.ListWorkerSessions)
		r.echo.DELETE("/internal/worker/sessions/:sessionId", r.handlers.provisionerController.DeleteWorkerSession)
		r.echo.POST("/internal/worker/sessions/:sessionId/messages", r.handlers.provisionerController.SendWorkerMessage)
		r.echo.GET("/internal/worker/stock", r.handlers.provisionerController.WorkerStock)
		r.echo.POST("/internal/worker/stock", r.handlers.provisionerController.WorkerStock)
		r.echo.DELETE("/internal/worker/stock", r.handlers.provisionerController.WorkerStock)
